        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-warning">
                    <h4 class="card-title">{{ __('Registro Insutrendy') }}</h4>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('registered') }}">
                        ...
                        <div class="form-group row">
                                <label for="bussinesstype" class="col-md-4 col-form-label text-md-right">{{ __('Clase de Negocio') }}</label>
    
                                <div class="col-md-6">
                                    <input id="bussinesstype" type="text" class="form-control @error('bussinesstype') is-invalid @enderror" name="bussinesstype" value="{{ old('bussinesstype') }}" required autocomplete="bussinesstype" autofocus>
